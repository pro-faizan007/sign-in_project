...
const SignUp = (props) => {
  ...
  const [userInput, setUserInput] = useState({ fullname: "", email: "", password: "" })
  ...
  const registerUser = async () => {
    const response = await fetch("http://localhost:3002/auth/c1/signup", {
      ...
      body: JSON.stringify({ fullName: userInput.fullname, email: userInput.email, password: userInput.password })
    })
  ...
  return (
    ...
    <>
      <Alerts alertClose={alertClose} alert={alert} />
                      ...
                      <form class="mx-1 mx-md-4">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example1c" class="form-control" name="fullname" value={userInput.fullname} onChange={change} />
